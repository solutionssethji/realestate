...
abstract class AppLocalizations {
  ...
  /// No description provided for @failedToLoadTour.
  ///
  /// In en, this message translates to:
  /// **'Failed to load 360° tour'**
  String get failedToLoadTour;
  ...
  /// No description provided for @projectPlot.
  ///
  /// In en, this message translates to:
  /// **'Project: {project} - Plot {plot}'**
  String projectPlot(String project, String plot);
  ...
  ///
  /// In en, this message translates to:
  /// **'A shiny new version ({latestVersion}) is waiting for you.\nWe have added new features and squashed some bugs.'**
  String updateDescription(String latestVersion);
